<?php
// ============================================================
// VIEW: Apertura tutorial — redirect al file del tutorial
// ============================================================
$id = (int)($params['id'] ?? -1);
$tutorial = $tutorials[$id] ?? null;

if ($tutorial && !empty($tutorial['file'])):
    header('Location: /' . $tutorial['file']);
    exit;
elseif ($tutorial):
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tutorial in arrivo</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .not-found h2 {
            ...
            color: var(--js-yellow); margin-bottom: 0.5rem;
        }
...
<body>
    <div class="not-found">
        <h2>Tutorial in arrivo</h2>
        <p><?= htmlspecialchars($tutorial['title']) ?> &egrave; ancora in preparazione.</p>
